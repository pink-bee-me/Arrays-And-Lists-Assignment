    ...
    static void Main()
    {
        ...
        try
        {
            ...
            Console.WriteLine("\n\n The code that you typed created an array named \"favoriteNumbersArray[ ]\"." +
                ...
                "\n This can be a very handy when using conditional statements and loops to search and/or sort through the information stored within arrays." +
        ...
        {
            Console.WriteLine(" The Index Location You Chose Does Not Exist.\n Please enter an index value that falls within the range of the specified array.");
        }
        catch (Exception ex)
        {
            Console.WriteLine("Please check user input to see if it meets the requested criteria of the program.");
        }
        finally
        {
            Console.ReadLine();
